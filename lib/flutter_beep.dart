...
class FlutterBeep {
  ...
  static Future<void> playSysSound(int soundId,
    ...
    if (durationSeconds > 0) {
      sleep(Duration(seconds: durationSeconds));
      await _channel.invokeMethod('stopSysSound');
    }
    return null;
  }
  ...
  static Future<void> stopSysSound() async {
    _channel.invokeMethod('stopSysSound');
  }

  static Future<void> beep([bool success = true]) {
    var soundId = (Platform.isAndroid) ? (success ? 24 : 25) : (success ? 1256 : 1257);
